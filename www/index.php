	...
	<div class="container bloc-sm">
		<nav class="navbar row mini-nav">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.php"><img src="img/logo-white.png" alt="logo" /></a>
			...
			<div class="collapse navbar-collapse navbar-1 special-dropdown-nav">
				<ul class="site-navigation nav navbar-nav">
					...
					<li>
						<a href="#stories" class="ltc-white" id="pl-undefined">STORIES</a>
					</li>
					<li>
						<a href="https://cotfc.com/give/" class="ltc-white" id="pl-undefined">GIVE</a>
					</li>
					<li>
					</li>
				</ul>
			...
			<div class="col-sm-6">
				...
				<form id="form_41305" novalidate success-msg="Thank you for your commitment!" fail-msg="We&rsquo;re sorry, something went wrong.">
					...
					<div class="form-group">
						...
						<input class="form-control field" id="zipcode_field" required />
					</div>
					<div class="form-group">
						<label class="form-label">
							Phone
...
<!-- Footer - stories -->
<div class="bloc bgc-white l-bloc" id="stories">
	<div class="container bloc-lg">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="mg-md  text-left tc-dark-jungle-green" id="-">
					Stories
				</h1>
			</div>
		</div>
		<div class="row voffset">
			<div class="col-sm-6">
				<div class="embed-responsive embed-responsive-16by9">
					<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/205810321" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen>
					</iframe>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="embed-responsive embed-responsive-16by9">
					<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/211750505" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen>
					</iframe>
				</div>
			</div>
			<div class="col-sm-6">
...
<!-- Footer - bloc-11 -->
<div class="bloc bgc-dark-jungle-green d-bloc" id="bloc-11">
	<div class="container bloc-lg">
		<div class="row">
			<div class="col-sm-12">
